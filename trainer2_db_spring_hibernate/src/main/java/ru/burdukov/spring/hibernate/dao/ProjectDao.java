package ru.burdukov.spring.hibernate.dao;
...
import ru.burdukov.spring.hibernate.mapper.QuestionMapper;
import ru.burdukov.spring.hibernate.repo.ProjectCurdRepository;
...
public class ProjectDao implements ProjectRepository {
    ...
    private ProjectEntity processQuestionsBeforeSave(ProjectEntity project) {
        project.getQuestions().forEach( task -> task.setProject(project));
        return project;
    }
}